...
| Sharpe Ratio | 0.645 ±2.755 | 1.244 ±1.713 | 1.367 ±2.018 | ← **Ensemble wins** |
| Win Rate | 43.1% ±0.065 | 47.3% ±0.080 | 44.6% ±0.061 | ← **HMM+LGB wins** |
| Total Return | 0.145% ±0.006 | 0.088% ±0.005 | 0.110% ±0.005 | ← **Baseline wins** |
| Max Drawdown | -0.399% ±0.002 | -0.402% ±0.006 | -0.373% ±0.005 | ← **HMM+LGB wins** |
...
|--------|--------|----------|---------|---------|
| W0 | 2024-03-22 → 2025-03-21 | -1.43 | -1.33 | -1.64 |
| W1 | 2024-04-22 → 2025-04-21 | -3.51 | -1.28 | -1.53 |
| W2 | 2024-05-20 → 2025-05-19 | -0.93 | +1.19 | +1.36 |
| W3 | 2024-06-18 → 2025-06-17 | +4.20 | +2.62 | +2.44 |
| W4 | 2024-07-18 → 2025-07-17 | +4.01 | +4.27 | +3.90 |
| W5 | 2024-08-15 → 2025-08-14 | +4.65 | +3.19 | +3.81 |
| W6 | 2024-09-13 → 2025-09-12 | +1.13 | +2.33 | +1.93 |
| W7 | 2024-10-11 → 2025-10-10 | +4.38 | +1.47 | +3.15 |
| W8 | 2024-11-08 → 2025-11-07 | +1.47 | +2.65 | +4.32 |
| W9 | 2024-12-09 → 2025-12-08 | +0.14 | +1.47 | +0.93 |
| W10 | 2025-01-08 → 2026-01-07 | -1.76 | -0.66 | -0.62 |
| W11 | 2025-02-07 → 2026-02-05 | -1.92 | +0.81 | +0.59 |
| W12 | 2025-03-10 → 2026-03-06 | -2.03 | -0.56 | -0.86 |
...
| Sharpe Ratio | 0.645 | 1.244 | +92.7% | ✅ Improved |
| Win Rate | 43.1% | 47.3% | +9.8% | ✅ Improved |
...
HMM+LightGBM Sharpe ratio **1.244** vs Baseline **0.645** — a **93% improvement**. Sharpe measures return per unit of risk. A higher Sharpe means the system generates returns more consistently without large losses. This is more important than raw total return for evaluating a trading system.
...
The Ensemble Sharpe (1.367) sits between Baseline (0.645) and HMM+LightGBM (1.244). Simple weighted blending does not always outperform the best individual model — a standard finding in ensemble research on financial data.
...
---
*Report generated automatically by run_full_comparison.py on 2026-03-21 07:28:57*