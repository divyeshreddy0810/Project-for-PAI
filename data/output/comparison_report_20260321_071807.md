...
|--------|----------|----------------|----------|--------|
| Forecast MAE (€) | 1943.51 ±1514.668 | 186.82 ±68.499 | 186.82 ±68.499 | ← **HMM+LGB wins** |
| Forecast RMSE (€) | 2345.31 ±1889.120 | 219.19 ±74.093 | 219.19 ±74.093 | ← **HMM+LGB wins** |
| Directional Accuracy | 48.5% ±0.144 | 46.3% ±0.124 | 46.3% ±0.124 | ← **Baseline wins** |
| Sharpe Ratio | 0.621 ±2.615 | 1.278 ±2.115 | 0.893 ±2.196 | ← **HMM+LGB wins** |
| Win Rate | 41.7% ±0.070 | 45.7% ±0.076 | 43.8% ±0.054 | ← **HMM+LGB wins** |
| Total Return | 0.123% ±0.005 | 0.062% ±0.002 | 0.014% ±0.002 | ← **Baseline wins** |
| Max Drawdown | -0.416% ±0.002 | -0.371% ±0.004 | -0.345% ±0.003 | ← **Baseline wins** |
...
|--------|--------|----------|---------|---------|
| W0 | 2024-03-22 → 2025-03-21 | -1.43 | -0.76 | -1.29 |
| W1 | 2024-06-04 → 2025-06-03 | +1.75 | +0.31 | -0.02 |
| W2 | 2024-08-15 → 2025-08-14 | +4.65 | +3.44 | +4.53 |
| W3 | 2024-10-25 → 2025-10-24 | +2.84 | +4.19 | +2.70 |
| W4 | 2025-01-08 → 2026-01-07 | -1.76 | +2.04 | +1.15 |
| W5 | 2025-03-24 → 2026-03-20 | -2.32 | -1.55 | -1.71 |
...
|--------|----------|---------|--------|---------|
| Forecast MAE | 1943.5 | 186.8 | -90.4% | ✅ Improved |
| Forecast RMSE | 2345.3 | 219.2 | -90.7% | ✅ Improved |
| Directional Accuracy | 48.5% | 46.3% | -4.6% | ❌ Worse |
| Sharpe Ratio | 0.621 | 1.278 | +105.8% | ✅ Improved |
| Win Rate | 41.7% | 45.7% | +9.6% | ✅ Improved |
...
HMM+LightGBM reduces price prediction error (MAE) by **90%** (1944 → 187 euros average error). LightGBM captures non-linear relationships between features that linear regression cannot model. The baseline's R²≈1.0 on training data indicates overfitting.

### 2. Risk-Adjusted Returns

HMM+LightGBM Sharpe ratio **1.278** vs Baseline **0.621** — a **106% improvement**. Sharpe measures return per unit of risk. A higher Sharpe means the system generates returns more consistently without large losses. This is more important than raw total return for evaluating a trading system.

### 3. Directional Accuracy Trade-off

Baseline correctly predicts price direction 48.5% of the time vs HMM+LightGBM 46.3%. LightGBM is optimised for price level accuracy (minimising squared error), not direction. Despite this, HMM+LightGBM achieves higher Sharpe because confidence-based position sizing allocates more capital to higher-quality predictions.
...
The Ensemble Sharpe (0.893) sits between Baseline (0.621) and HMM+LightGBM (1.278). Simple weighted blending does not always outperform the best individual model — a standard finding in ensemble research on financial data.
...
---
*Report generated automatically by run_full_comparison.py on 2026-03-21 07:18:07*